...
export const WifiStaCntKey = 'sta-count';
export const BluetoothCntKey = 'bluetooth-cnt';
export const IlluminationKey = 'illumination';
export const BluetoothNameKey = 'bluetooth-devices';
