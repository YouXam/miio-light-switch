...
export default class extends Component {
  render() {
    ...
    let title = this.props.title ?? navigation.getParam('title', Device.name);
    let hideRightButton = this.props.hideRightButton === undefined ? navigation.getParam('hideRightButton') : this.props.hideRightButton;
